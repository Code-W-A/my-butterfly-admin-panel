      ...
      <PopoverContent align="end">
        <div className="flex flex-col gap-5">
          <div className="space-y-1.5">
            <h4 className="font-medium text-sm leading-none">Preferințe</h4>
            <p className="text-muted-foreground text-xs">Personalizează preferințele de aspect ale panoului.</p>
            <p className="font-medium text-muted-foreground text-xs">
              *Preferințele folosesc cookie-uri implicit. Poți schimba între cookie-uri, localStorage sau fără stocare
              în cod.
            </p>
          </div>
          <div className="space-y-3 **:data-[slot=toggle-group]:w-full **:data-[slot=toggle-group-item]:flex-1 **:data-[slot=toggle-group-item]:text-xs">
            <div className="space-y-1">
              <Label className="font-medium text-xs">Preset temă</Label>
            ...
            <div className="space-y-1">
              <Label className="font-medium text-xs">Fonturi</Label>
            ...
            <div className="space-y-1">
              <Label className="font-medium text-xs">Mod temă</Label>
              <ToggleGroup
                size="sm"
                variant="outline"
                type="single"
              ...
              >
                <ToggleGroupItem value="light" aria-label="Comută pe lumină">
                  Lumină
                </ToggleGroupItem>
                <ToggleGroupItem value="dark" aria-label="Comută pe întunecat">
                  Întunecat
                </ToggleGroupItem>
                <ToggleGroupItem value="system" aria-label="Comută pe sistem">
                  Sistem
                </ToggleGroupItem>
              </ToggleGroup>
            </div>
            ...
            <div className="space-y-1">
              <Label className="font-medium text-xs">Aspect pagină</Label>
              <ToggleGroup
                size="sm"
                variant="outline"
                type="single"
              ...
              >
                <ToggleGroupItem value="centered" aria-label="Comută pe centrat">
                  Centrat
                </ToggleGroupItem>
                <ToggleGroupItem value="full-width" aria-label="Comută pe lățime completă">
                  Lățime completă
                </ToggleGroupItem>
              </ToggleGroup>
            </div>
            ...
            <div className="space-y-1">
              <Label className="font-medium text-xs">Comportament bară</Label>
              <ToggleGroup
                size="sm"
                variant="outline"
                type="single"
              ...
              >
                <ToggleGroupItem value="sticky" aria-label="Comută pe sticky">
                  Sticky
                </ToggleGroupItem>
                <ToggleGroupItem value="scroll" aria-label="Comută pe scroll">
                  Scroll
                </ToggleGroupItem>
              </ToggleGroup>
            </div>
            ...
            <div className="space-y-1">
              <Label className="font-medium text-xs">Stil sidebar</Label>
              <ToggleGroup
                size="sm"
                variant="outline"
                type="single"
              ...
              >
                <ToggleGroupItem value="inset" aria-label="Comută pe inset">
                  Inset
                </ToggleGroupItem>
                <ToggleGroupItem value="sidebar" aria-label="Comută pe sidebar">
                  Sidebar
                </ToggleGroupItem>
                <ToggleGroupItem value="floating" aria-label="Comută pe floating">
                  Flotant
                </ToggleGroupItem>
              </ToggleGroup>
            </div>
            ...
            <div className="space-y-1">
              <Label className="font-medium text-xs">Mod colapsare sidebar</Label>
              <ToggleGroup
                size="sm"
                variant="outline"
                type="single"
              ...
              >
                <ToggleGroupItem value="icon" aria-label="Comută pe icon">
                  Pictogramă
                </ToggleGroupItem>
                <ToggleGroupItem value="offcanvas" aria-label="Comută pe offcanvas">
                  OffCanvas
                </ToggleGroupItem>
              </ToggleGroup>
            </div>
